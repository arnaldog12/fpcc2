...
plot_python_fds <- mean.python_fds$replicates %>%
  ...
  ggtitle("Distribuição amostral da média de usuários durante fim de semana") +
...
plot_python_dds <- mean.python_dds$replicates %>%
  ...
  ggtitle("Distribuição amostral da média de usuários durante a semana") +
  labs(x = "Média de usuários", y = "Quantidade")
...
Pelos gráficos acima, conseguimos afirmar com 95% de confiança que __a média de usuários que alteram arquivos python durante o final de semana está entre [2467.722, 2576.545]__. Por outro lado, __a média de usuários durante a semana está entre [4588.282, 4709.251], também com 95% de confiança__. Ambos os intervalos de confiança estão destacados em azul no gráfico. As linhas amarela e verde representam, respectivamente, as médias de usuários que editam arquivos python durante o fim de semana e durante a semana (média dos dados originais onde foram efetuados os _bootstrap_). __Vale ressaltar que os intervalos de confiança mostrados estimam a média da população__.
...
df %>%
  ...
  ggtitle("Intervalos de confiança para a média de usuários") +
  labs(x = "Linguagem (amostra)", y = "Intervalo de confiança") +
  scale_x_discrete(labels = c("mean_c_dds"="C (semana)", "mean_c_fds"="C (fim de semana)", "mean_python_dds"="Python (semana)", "mean_python_fds"="Python (fim de semana)"))
