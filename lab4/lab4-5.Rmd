...
Ainda, o teste de hipótese que vamos utilizar será _two-tailed_, com nível de significância $\alpha=95\%$.
...
Logo, dado que a hipótese nula ($H_0$) é verdadeira, a probabilidade de se obter um teste estatístico mais extremo que o observado é 0.1509245. Como $p\mbox{-}value > 0.05$, não podemos rejeitar $H_0$. Portanto, não há uma diferença significativa entre a popularidade de desenvolvedores durante a semana e durante o fim de semana.
