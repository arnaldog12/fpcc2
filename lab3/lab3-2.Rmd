...
É importante notar que as variáveis (eixo x) estão distribuidas diferentemente nos dois gráficos. Entretanto, acredito que podemos diferenciar os 3 grupos da seguinte forma:

- Filmes de alta bilheteria, alto orçamento, longa duração, muitas curtidas no facebook e atores renomados;
- Filmes de bilheteria média, médio orçamento, longa duração, certas curtidas no facebook e atores renomados;
- Filmes de baixa bilheteria, baixo orçamento, curta duração, baixa avaliação, poucas curtidas no facebook e atores desconhecidos;
...
De acordo com o gráfico, podemos dizer que os 3 grupos se caracterizam da seguinte forma (não necessariamente nessa ordem):

- Filmes de baixa avaliação, menor duração, poucos/médios likes no facebook e atores com poucos/médios likes;
- Filme de longa duração, média quantidade de likes no facebook e atores renomados;
- Filmes de alta bilheteria, alto orçamento, longa duração, boa avaliação, muitas curtidas no facebook e atores renomados;

__Observação__: não citei todas as variáveis em todos os grupos, pois acredito que elas não contribuiram significantemente para a categorização daquele grupo em comparação com os demais.
...
* Houve um grupo parecido nos dois métodos: os filmes com baixa avaliação.