...
Agora vou utilizar o K-means para clusterização. Vou começar analisando o valor de _tot.withinss_ para o K-means aplicado de 2 a 12 grupos. O valor de _tot.withinss_ representa o somatório dos quadrados das distâncias de cada ponto em cluster $c_i$ para o centro do cluster. Esse valor tende a zero quando o número de clusters é igual ao número de pontos.
...
__Grupo 1__: _Fora do padrão_ (Universidades modelo)
...
Interessante notar as universidades do __Grupo 2__. A UFPB e UFCG, agora, aparecem na _Série B_.
