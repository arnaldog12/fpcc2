...
Podemos observar que as universidades do _Grupo 2_ se situam bem mais próximos dos demais grupos agora que em relação aos resultado obtido com o PCA. Interessante notar que onde $V1 > 0$ e $V2 > 0$, praticamente só há dados do _Grupo 1_. Comportamento, este, bem diferente do resultado do PCA.
