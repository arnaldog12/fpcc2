...
Vamos agora analisar a dispersão das variáveis em relação ao score. Novamente, vou separar essa análise para as variáveis númericas e categóricas. No caso das variáveis númerica, também calcularei o coeficiente de correlação.
...
A relação entre as variáveis categóricas e o score não nos diz muita coisa. Porém, um fato interessante que pode ser observado é a tendência de scores mais altos para disciplinas de um crédito.

Por fim, vamos focar nossa análise descritiva na variável que vamos utilizar para fazer o nosso modelo linear simples: *bty_avg*. Primeiramente, vamos analisar a distribuição dos _scores_ e de *bty_avg* através de um boxplot:
...
Analisando os gráficos acima podemos observar que os nossos resíduos são 
...
* __Normal Q-Q__: esse gráfico mostra se os resíduos são normalmente distribuídos. Como vimos anteriormente, nossos resíduos são concetrados à direita com cauda a esquerda.
